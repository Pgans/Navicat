SELECT 'รพ.ม่วงสามสิบ'as HOSPNAME,a.HN,CONCAT(trim(d.FNAME),' ',d.LNAME) AS FULLNAME,TIMESTAMPDIFF(year,d.BIRTHDATE,a.REG_DATETIME) as AGE, 
...
AND d.CID in (SELECT fs.cid FROM f32 fs)
