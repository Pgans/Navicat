SELECT a.UNIT_NAME , COUNT(a.HN) AS 'จำนวน(คน) 'FROM
...
AND deaths.DEATH_DATE BETWEEN "20141001" and "20150930"
GROUP BY opd_visits.HN
ORDER BY deaths.DEATH_DATE) AS a  GROUP BY a.UNIT_NAME ORDER BY count(hn) DESC;