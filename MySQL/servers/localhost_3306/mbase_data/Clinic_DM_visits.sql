...
WHEN  2 THEN 'หญิง'
WHEN  3 THEN 'กะเทย'
END AS 'เพศ',DATE_format(opd_visits.REG_DATETIME,'%Y%m%d') AS 'วันที่มรพ.',icd10new.ICD10_TM AS 'การวินิจฉัย',service_units.UNIT_NAME,
...
AND  opd_visits.REG_DATETIME BETWEEN '20160101' AND '20160430'
