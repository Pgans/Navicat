SELECT a.SURGEON_ID,CONCAT(c.FNAME,'',TRIM(c.LNAME))AS Provider, COUNT(CASE WHEN SUBSTR(tname,1,3) ='ฝัง' THEN '1' END) AS 'ฝังเข็ม',
...
WHERE REGDATE BETWEEN '2018-09-01' AND '2018-09-02'
GROUP BY SURGEON_ID ORDER BY a.SURGEON_ID