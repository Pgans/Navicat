...
FROM mbase_data.gcoffice, mbase_data.population,cid_hn
INNER JOIN  mbase_data.opd_visits ON opd_visits.HN = cid_hn.HN
INNER JOIN mbase_data.opd_diagnosis ON opd_diagnosis.VISIT_ID = opd_visits.VISIT_ID 
INNER JOIN mbase_data.icd10new ON opd_diagnosis.icd10 = icd10new.icd10
WHERE opd_visits.REG_DATETIME > '2017.10.01 00:00' 
