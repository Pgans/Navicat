SELECT DISTINCT population.CID, ipd_reg.ADM_ID, cid_hn.HN ,refers.RF_DT, hosp_nhso.HOSP_NAME, population.FNAME, population.LNAME,
...
GROUP BY ipd_reg.ADM_ID  ORDER BY refers.RF_DT