SELECT DISTINCT cid_hn.HN, DATE_FORMAT(opd_visits.REG_DATETIME,'%Y%d%m') AS 'วันที่มารับบริการ',
CASE 
...
WHEN  2 THEN 'หญิง'
WHEN  3 THEN 'กะเทย'
END AS 'เพศ', icd10new.ICD10_TM AS 'การวินิจฉัย',
...
INNER JOIN icd10new ON icd10new.ICD10_ID = opd_diagnosis.ICD10_ID AND LEFT(icd10new.ICD10_TM,1)= 'E'
...
AND opd_visits.REG_DATETIME BETWEEN '20150101' AND '20150430'
