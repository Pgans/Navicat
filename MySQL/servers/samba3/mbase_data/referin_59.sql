SELECT  opd_visits.VISIT_ID,s.UNIT_ID,s.UNIT_NAME, hosp_nhso.HOSP_ID AS 'hospid', hosp_nhso.hosp_name ,date_format(refers.RF_DT,'%Y-%m-%d')as 'referdate'
...
INNER JOIN service_units s ON opd_visits.UNIT_REG = s.UNIT_ID
WHERE population.CID = cid_hn.CID
AND cid_hn.HN = opd_visits.HN
#AND hosp_nhso.HOSP_ID = $hospid
AND refers.RF_DT BETWEEN '20151001' AND '20160930' 
