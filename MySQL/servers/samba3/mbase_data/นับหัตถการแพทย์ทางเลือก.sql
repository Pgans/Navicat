SELECT REG_DATE, COUNT(CASE WHEN(CODE ='99.92') THEN '1' END) AS 'Acupuncture',
...
COUNT(CASE WHEN CODE BETWEEN '900-79-00'AND '900-79-99' THEN 'xx' END) AS 'ส่งเสริม', COUNT(`CODE`) AS Total
FROM mb_thaimedoper 
WHERE REG_DATE BETWEEN '2017-01-01' AND '2018-01-31' GROUP BY REG_DATE ORDER BY REG_DATE
