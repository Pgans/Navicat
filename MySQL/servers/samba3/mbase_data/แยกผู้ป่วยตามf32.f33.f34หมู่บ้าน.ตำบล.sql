...
INNER JOIN icd10new ON icd10new.ICD10_ID = opd_diagnosis.ICD10_ID AND icd10new.ICD10_TM IN ('F33','f33','f34','f38','f39')
...
AND opd_visits.REG_DATETIME BETWEEN '2010.10.01 00:00' AND '2015.09.30 23:59'
AND opd_visits.is_cancel = 0 
ORDER BY opd_visits.REG_DATETIME,icd10new.ICD10;